...
I have have added: **Update_ACS1_samplelist.txt** to be used in place of original *samplelist.txt*. Once downloaded, remove file *samplelist.txt* and rename **Update_ACS1_samplelist.txt** as "samplelist.txt" 
